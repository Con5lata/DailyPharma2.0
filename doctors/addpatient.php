...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($patient_ssn && $patient_name && $patient_email && $patient_phone && $patient_age) {
        ...
        $sql = "INSERT INTO patients (Patient_SSN, Patient_Name, Patient_Email, Patient_Phone, Patient_Gender, Patient_DOB) 
                VALUES ('$patient_ssn', '$patient_name', '$patient_email', '$patient_phone', '$patient_gender','$patient_age')";
