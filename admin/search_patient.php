            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . htmlspecialchars($row['Patient_DOB']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['Patient_Age']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['Password']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['Status']) . "</td>";
                        echo "<td><a class='btn btn-danger btn-sm' href='doctoredit.php?SSN={$row['Patient_SSN']}'>Edit</a></td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='7'>No patients found</td></tr>";  // Update colspan to match the number of columns
                }
